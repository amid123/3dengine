...
void arc::vectro2dScale(arc::VECTOR2D* vect, float scalar)
{
	vect->V[0] *= scalar;
	vect->V[1] *= scalar;
}

void arc::vectro3dScale(arc::VECTOR3D* vect, float scalar)
{
	vect->V[0] *= scalar;
	vect->V[1] *= scalar;
	vect->V[2] *= scalar;
...
void arc::vectro4dScale(arc::VECTOR4D* vect, float scalar)
{
	vect->V[0] *= scalar;
	vect->V[1] *= scalar;
	vect->V[2] *= scalar;
