...
arc::face::face(vert3d *vert1, vert3d *vert2,vert3d *vert3, face *fcl, face *fcf): v1(vert1), v2(vert2), v3(vert3), last(fcl),next(0),buf(0),first(fcf),faceNum(0),visible(true)
{
