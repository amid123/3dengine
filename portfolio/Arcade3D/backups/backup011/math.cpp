...
arc::trig::trig()
{
	this->trigTabSize = 360 * 10;
	this->sinTab = new double [trigTabSize];
	this->cosTab = new double [trigTabSize];
	this->tgnTab = new double [trigTabSize];
	this->ctgTab = new double [trigTabSize];
}*/