...
void arc::arc3d::render()
{
	...
	for(unsigned int i = 0 ; i < this->mainScene->objects.size() ; i++)
	{
		...
		for(unsigned int j = 0 ; j < this->mainScene->objects[i].vertexList.size ; j++)
		{
			...
			this->mainScene->objects[i].vertexList.indexList[j]->global.x = x_buf + this->mainScene->objects[i].pos_x();
			this->mainScene->objects[i].vertexList.indexList[j]->global.y = y_buf + this->mainScene->objects[i].pos_y();
			this->mainScene->objects[i].vertexList.indexList[j]->global.z = z_buf + this->mainScene->objects[i].pos_z();
			...
			//x_buf = this->mainScene->objects[i].vertexList.indexList[j]->global.x;
			//y_buf = this->mainScene->objects[i].vertexList.indexList[j]->global.y;
			//z_buf = this->mainScene->objects[i].vertexList.indexList[j]->global.z;
			...
			dist = this->mainScene->mainCamera->getDist();
			aspect = this->mainScene->mainCamera->getAspectRatio();
