...
void arc::transformation::addTranslation(float x,float y,float z)
{
	...
	{
		this->vertexList.indexList[i]->local_x = this->vertexList.indexList[i]->local_x + x;
		this->vertexList.indexList[i]->local_y = this->vertexList.indexList[i]->local_y + y;
		this->vertexList.indexList[i]->local_z = this->vertexList.indexList[i]->local_z + z;
	}
}
