	...
	case VERTEX_VIEW:
		...
		for(unsigned int j = 0 ; j < this->mainScene->objects.size() ; j++)
			for(unsigned int i = 0 ; i < this->mainScene->objects[j].vertexList.size ; i++)
			{
				...
				this->putPixel((int)(scr_x_zero + (this->mainScene->objects[j].vertexList.indexList[i]->scr_x * 150)),
							   (int)(scr_x_zero + (this->mainScene->objects[j].vertexList.indexList[i]->scr_y * 150)),&col);
	...
	case EDGE_VIEW:
		...
		for(unsigned int j = 0 ; j < this->mainScene->objects.size() ; j++)
			for(unsigned int i = 0 ; i < this->mainScene->objects[j].faceList.size ; i++)
			{
				...
				this->drawLine( (int)(scr_x_zero + (this->mainScene->objects[j].faceList.indexList[i]->v1->scr_x * 150)),
								(int)(scr_y_zero + (this->mainScene->objects[j].faceList.indexList[i]->v1->scr_y * 150)),
							    (int)(scr_x_zero + (this->mainScene->objects[j].faceList.indexList[i]->v2->scr_x * 150)),
							    (int)(scr_y_zero + (this->mainScene->objects[j].faceList.indexList[i]->v2->scr_y * 150)));
																												  
				this->drawLine( (int)(scr_x_zero + (this->mainScene->objects[j].faceList.indexList[i]->v2->scr_x * 150)),
							    (int)(scr_y_zero + (this->mainScene->objects[j].faceList.indexList[i]->v2->scr_y * 150)),
							    (int)(scr_x_zero + (this->mainScene->objects[j].faceList.indexList[i]->v3->scr_x * 150)),
							    (int)(scr_y_zero + (this->mainScene->objects[j].faceList.indexList[i]->v3->scr_y * 150)));
																												  
				this->drawLine( (int)(scr_x_zero + (this->mainScene->objects[j].faceList.indexList[i]->v3->scr_x * 150)),
							    (int)(scr_y_zero + (this->mainScene->objects[j].faceList.indexList[i]->v3->scr_y * 150)),
							    (int)(scr_x_zero + (this->mainScene->objects[j].faceList.indexList[i]->v1->scr_x * 150)),
							    (int)(scr_y_zero + (this->mainScene->objects[j].faceList.indexList[i]->v1->scr_y * 150)));
			}
